...
1. A neighborhood could potentially exist anywhere there are people. A strain of urban theory in the 1980s and 1990s, typified by Kunstler's _The Geography of Nowhere_ [-@Kunstler1994; ca. @Garreau1991], arose that dismissed low-density, suburban development as largely outside the scope of traditional views on community and neighborhood. According to this strain of thought, there are certain areas (identifiable by low population density) where it is impossible to have neighborhoods. I think this approach is misguided. Neighborhoods may be less pervasive in suburban areas, but there is no way to *a priori* define certain areas as off-limits to neighborhoods.
