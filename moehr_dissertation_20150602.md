...
Second, there is a growing body of literature suggesting that activity spaces and travel patterns may be better representations of neighborhoods. @Matthews2013a is the foremost champion of this approach at the moment, but it has its roots in the GIS, feminist, and multi-method research pioneered by Mei-Po Kwan and colleagues [@Kwan2002; @Kwan2009; @Kwan2008]. The basic idea is that if we understand people's daily movement then we can define their neighborhood as the area where they usually work, play, shop, learn, and live. Again, these methods have, to my knowledge, only been applied in small samples in a few urban settings. However, with increases in GPS enabled mobile phone use and improvements in wearable activity tracking technology, it may become more practical to implement these methods with large, random, and nation-wide samples.
...
I would like to clearly state the contributions and conceptualizations that my dissertation makes to the field of spatial demography. However, I can't do that without careful consideration of how we, as sociologists, frame our research. "How we frame our research" is another way of saying how we engage with the philosophy of science. This section summarizes my contributions to the field, but to do that, I take a detour through the philosophy of science, and I apologize ahead of time if this seems pretentious, but I promise there are concrete statements at the end of the section. First, I will explain 3 perspectives on the philosophy of (social) science, and why they are a poor fit for my empirical work. Then I will explain the perspective I most often use in my own thinking about neighborhood effects, social media, and spatial demography. Since the philosophical terminology can be confusing in these debates, I have chosen to give each of the perspectives a nickname.

The first perspective on the philosophy of science is the Myra. This perspective is based on the standard social science model or "critical realism." I call this perspective Myra because this is the core methodological training for all Wisconsin sociology graduate students under the tutelage of Myra Marx Ferree. Alternatively, it could be called the Andy [@Sayer1984] based on one of its foundational books or the Phil [@Gorski2013], due to its current popularizer. In order to summarize the contributions of a research project, the Myra perspective suggests that we can fill in this boilerplate framework:
...
The Howie works for many fields of sociology, but I don't think it works for neighborhoods. My concrete finding might be...
...
... which seems like a justifiable theoretical claim, but I think it's just a restatement of sociology's founding tenant: no person is an island. The Howie fails in this situation because neighborhoods are not a subtype of social groups in the same way that schools are a subtype of "bureaucratic systems." Neighborhoods are weird; they're different from other social groups because of their geographic existence; their importance for multi-generational processes; and their centrality in the power dynamic of governments, real estate developers, and local residents. Neighborhoods are also different from institutions -- schools, state-level governments, employers -- because they  do not have any mechanisms with which to directly control people. As an institution, neighborhoods are both weaker and stronger[^stronger] than other social groups.
...
On most levels, the Chuck works for my dissertation. As one example: I grew up in a very small, very white farming town. My childhood was filled with experiences and places that could have been straight out of Slim's Table, Urban Villagers, or Wirth's writing. I was strongly influenced by neighborhood effects, but my hometown does not have any neighborhoods. This paradox led me to define models of neighborhood effects allowing for gaps between neighborhoods and "unneighborhood" effects. I think Mills and Bourdieu would be proud of the way I can weave my personal experiences into part of my scholarship, however, I think urban sociology has a unique challenge that arises because too many researchers use the Chuck.

Sampson [-@Sampson2012, 406] , the entire Chicago school, David Harvey, and even going back to Frederick Engels [@Engels1844, 46-7], all like to include a few pages that describe how they stroll through the city observing neighborhood things like the physical appearance of buildings, the behavior of people on the sidewalks, and the sound of cars or trains. This type of "strolling" behavior is always done by white dudes, and it's entirely possible that being a white dude is a prerequisite for experiencing and writing about a city in their manner. Feminist scholars have pointed out that strolling through a city is a privileged point of view [@Massey1994, especially 234; @Kwan2002], therefore, we should be more suspicious of sociological work that tries to unproblematically use the experiences of its authors when they take on the guise of flâneur.

Fourth, and finally, is the Thomas. Kuhn's [-@Kuhn1962] approach to paradigms of social science research has served as the most useful tool for understanding the theoretical contributions of my dissertation project. Most importantly, @Kuhn1962 [44] says that paradigms do not have strict rules or fundamental laws, but are instead made up of a set of shared research questions and methodological practices. For Kuhn, there are two types of research: normal science and anomalies. Normal science is the attempt to solve the puzzles defined by the paradigm with the tools known within the paradigm. When anomalous results arise, a paradigm is not abandoned -- instead, additional "normal science" is conducted to try to resolve the anomaly, and it is only after many rounds of anomalies and resolutions that a new paradigm might arise. One of the problems in the neighborhood effects paradigm is that we don't know how to define neighborhoods. This problem sounds very much like what Kuhn describes:
...
Using geotagged photographs to define neighborhoods is a (not so minor) articulation of the current neighborhood effects paradigm. My research is part of the "debate over fundamentals" that Kuhn notes as a sure sign of a paradigm in crisis [-@Kuhn1962, 91]. The theoretical contribution of my work lies in the fact that it uses a different approach to defining neighborhoods. It shows that different conclusions arise from Flickr-defined neighborhoods compared to the paradigm's accepted method of using administrative boundaries, e.g. census tracts. Note that I am not claiming to offer a new paradigm, because, as many people have noted [@Kuhn1962, 148; see the summary of the Duhem-Quine Thesis in @Gillies1993, chp 5], scientific progress does not happen by testing two competing paradigms against one another (as the Myra would suggest). Instead, anomalies and *ad hoc* explanations accumulate in the paradigm until its practitioners are too embarrassed to support it any longer, and then they (perhaps begrudgingly) switch their research questions and methodological tools to a new paradigm.

In conclusion, I don't want to use the Myra because the neighborhood effects literature does not fit into its boilerplate framework. I don't want to use the Howie because I think there is something unique about neighborhoods that can not be abstracted into "social groups." I do not want to use the Chuck because I don't want to contribute any more flâunerism to the field of urban sociology. Therefore, my theoretical contributions come in through the use of the philosophy of science as described by Thomas Kuhn. I am contributing another "divergent articulation" to the field of neighborhood effects research by spurring on a debate about definitions of its fundamental concept of the neighborhood.
...
In chapter 3, I concentrate on the MAUP by comparing Flickr boundaries in Chicago with 3 alternatives: census tracts, a raster, and neighborhoods defined by the Project for Human Development in Chicago Neighborhoods (PHDCN) [@Sampson2012, chp 4]. To compare the alternative neighborhood definitions in a real-world example, I use homicide data. Through univariate analysis and spatial models, I argue that the Flickr neighborhoods are better than census tracts, better than the rasters, and at least as good as the PHDCN definitions. Since the PHDCN project put a considerable amount of effort and expertise into constructing their neighborhoods, it is quite significant that I, as a non-expert on Chicago, can use Flickr to make definitions just as good as the experts. Additionally, I show that the Flickr neighborhoods will produce a dramatically higher variance in the counts of homicides than the PHDCN neighborhoods. This is a surprising finding because Flickr has fewer neighborhoods than PHDCN, and therefore, we would expect it to have lower variance. The results of the models gives us good evidence for a way to solve the MAUP. The surprising finding about the variance points out the need for future research on the connection between neighborhood definitions, measurements of variance, and known sociological research on residential segregation.
...
Phoenix has 14 village planning areas that are officially recognized by the city. I used these 14 areas as the standard way to measure neighborhoods. They are probably better than census tracts at operationalizing neighborhoods because they were constructed to help local village planning boards, and they are assigned recognizable names. On visual inspection, the official village planning areas are about the same size as Flickr neighborhoods, which is important given that I use the percent of overlap as in my analytical approach. If I were to do the comparison between Flickr neighborhoods and census tracts, I would most certainly find evidence to support my argument. However, it would be weak data because the Flickr neighborhoods are much larger than census tracts, so I would essentially be fixing the game in my favor. I use the village planners instead because they represent a tougher case -- if I can show that Flickr neighborhoods are different from village planners, then I will have stronger evidence that my new method is different *in important ways* from the standard measures of neighborhoods.
...
# Using Flickr neighborhoods to solve the MAUP: Data from homicide patterns in Chicago
...
I tend to answer that neighborhoods, as one example of a "geographical area," are indeed entities[^some]. Thus, in order to come as close as possible to solving the MAUP, we should define neighborhoods in a way to correspond to their real world existence (as much as possible). 
...
I will introduce an alternative set of neighborhood boundaries based on geotagged photographs from the Flickr photo sharing service, and test if the collective wisdom of Flickr users can provide an operationalization as good as, or better than the PHDCN. If Flickr can provide acceptable neighborhoods we could improve many areas of spatial research without launching expensive studies like the PHDCN in every city. And to address the MAUP, it will be useful to compare models that use Sampson's neighborhoods and Flickr neighborhoods in order to quantify how much each of them might fall prey to the old nemesis.
...
However, I think it is important to note that the inclusion of a spatial parameter does not "solve" the MAUP. @Sampson2012 [258] is flat wrong in this assertion:
...
In conclusion I would like to take a step back and record my thoughts on neighborhood effects, social media research, their special challenges and their unique opportunities. First, though, a brief summary of the three empirical chapters.
...
In Chapter 3, I engaged with the old problem of the modifiable areal unit, which has been around for decades. Flickr-defined neighborhoods exemplify two of the approaches set out by @Jelinski1996 [136] for dealing with the MAUP. First, they are not "modifiable" in the sense that they can be recombined in arbitrary aggregations like census tracts. Flickr-defined neighborhoods are more sociologically meaningful than census tracts. Second, I used an empirical example from homicide data in Chicago to demonstrate that neighborhoods from the Project on Human Development in Chicago Neighborhoods (PHDCN) are no better within a spatial modeling framework than Flickr neighborhoods. In other words, Flickr neighborhoods are no more sensitive to the MAUP than the neighborhood definitions carefully crafted by experts at the PHDCN. These two approaches combine to strongly suggest that Flickr-defined neighborhoods are an important advancement for dealing with the MAUP.
...
Many of the critiques of my work come from the point of view that my empirics do not exhibit the "good" properties of survey data: representativeness, standardized questions, comparability between subjects, reproducibility. But rather than haggle with my critics over the shortcomings of social media data, I would like to offer a brief aside about survey research.
...
In Chapter 4 I used alpha shapes for two reasons: a) convenience and b) they allowed overlapping neighborhoods and gaps. Convenience was a valid concern in this chapter because it analyzes nation-wide data with about 61,000 neighborhoods. The national dataset of alpha shapes has already been [published by Flickr](http://code.flickr.net/2011/01/08/flickr-shapefiles-public-dataset-2-0/), so it could be downloaded and used without any additional processing. The chapter is directed mostly at the question of whether neighborhoods are better conceptualized as overlapping and non-extensive, so comparing alpha shapes with census tracts is the best possible test for the hypothesis. The major draw back is that alpha shapes make a lot of weird shapes.
